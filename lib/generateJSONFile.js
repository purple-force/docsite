...
const langs = ['zh-cn', 'en-us', 'ja-jp', 'it-it'];
...
const generateJSONFile = (env, cwd) => {
  ...
  generate(env, cwd, 'docs', 'ja-jp', docsData);
  generate(env, cwd, 'docs', 'it-it', docsData);
  generate(env, cwd, 'blog', 'zh-cn', blogData);
  generate(env, cwd, 'blog', 'en-us', blogData);
  generate(env, cwd, 'blog', 'ja-jp', blogData);
  generate(env, cwd, 'blog', 'it-it', blogData);
